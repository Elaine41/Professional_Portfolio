...
CREATE TABLE `address` (
  `add_id` int NOT NULL,
  `delivery_address1` varchar(200) COLLATE utf8mb3_unicode_ci NOT NULL,
  `delivery_address2` varchar(200) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `delivery_city` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `delivery_zipcode` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`add_id`)
...
CREATE TABLE `customers` (
  ...
  `cust_firstname` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `cust_lastname` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`cust_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `ingredient` (
  `ing_id` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
  `ing_name` varchar(200) COLLATE utf8mb3_unicode_ci NOT NULL,
  `ing_weight` int NOT NULL,
  `ing_meas` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `inventory` (
  `inv_id` int NOT NULL,
  `item_id` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `item` (
  ...
  `item_cat` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL,
  `item_size` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `orders` (
  `row_id` int NOT NULL,
  `order_id` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `recipe` (
  `row_id` int NOT NULL,
  `recipe_id` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  `ing_id` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
  `quantity` int NOT NULL,
  PRIMARY KEY (`row_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `rota` (
  `row_id` int NOT NULL,
  `rota_id` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  `date` datetime NOT NULL,
  `shift_id` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `shift` (
  `shift_id` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  `day_of_week` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `stock2` AS select `s2`.`ing_name` AS `ing_name`,`s2`.`ordered_weight` AS `ordered_weight`,`ing`.`ing_weight` AS `ing_weight`,`inv`.`quantity` AS `quantity`,(`ing`.`ing_weight` * `inv`.`quantity`) AS `total_inv_weight` from (((select `stock1`.`ing_id` AS `ing_id`,`stock1`.`ing_name` AS `ing_name`,sum(`stock1`.`ordered_weight`) AS `ordered_weight` from `stock1` group by `stock1`.`ing_name`,`stock1`.`ing_id`) `s2` left join `inventory` `inv` on((`inv`.`item_id` = `s2`.`ing_id`))) left join `ingredient` `ing` on((`ing`.`ing_id` = `s2`.`ing_id`)));
